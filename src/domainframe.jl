...
call_setexpansion(e::SetExpansion, s::DomainFrame, coef, x...) = call_expansion(basis(s), coef, x...)

call_setexpansion!(result, e::SetExpansion, s::DomainFrame, coef, x...) = call_expansion!(result, basis(s), coef, x...)
