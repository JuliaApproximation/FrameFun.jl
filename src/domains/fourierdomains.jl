...
(<)(f::SetFun{N,T}, a::Number) where {N, T<:Number} = FourierDomain{SVector{N,T}}(f, x-> x < a)
(<=)(f::SetFun{N,T}, a::Number) where {T<:Number, N} = FourierDomain{SVector{N,T}}(f, x-> x <= a)
(>)(f::SetFun{N,T}, a::Number) where {T<:Number, N} = FourierDomain{SVector{N,T}}(f, x-> x > a)
(>=)(f::SetFun{N,T}, a::Number) where {T<:Number, N} = FourierDomain{SVector{N,T}}(f, x-> x >= a)
...
(<)(f::SetFun{N,T}, g::SetFun{N,T}) where {N,T<:Number} = ComparisonDomain{SVector{N,T}}(f, g, (x,y)-> x < y)
(<=)(f::SetFun{N,T}, g::SetFun{N,T}) where {N,T<:Number} = ComparisonDomain{SVector{N,T}}(f, g, (x,y)-> x <= y)
(>)(f::SetFun{N,T}, g::SetFun{N,T}) where {N,T<:Number} = ComparisonDomain{SVector{N,T}}(f, g, (x,y)-> x > y)
(>=)(f::SetFun{N,T}, g::SetFun{N,T}) where {N,T<:Number} = ComparisonDomain{SVector{N,T}}(f, g, (x,y)-> x >= y)
